        ...
        <div class="row-fluid form-wrapper">
            <div class="span9 with-sidebar">
                <div class="container">
                    ...
                    ?>
                    <?php 
                        echo $form->field($model, 'adminuser')->textInput(['class' => 'span9', 'disabled' => true]); 
                    ?>
                    <?php 
                        echo $form->field($model, 'adminpass')->passwordInput(['class' => 'span9']); 
                    ?>
                    <?php 
                    ...
                    <div class="span11 field-box actions">
                        <?php 
                            echo Html::submitButton('修改', ['class' => 'btn-glow primary']); 
                        ?>
                        <span>
                            或者
                        </span>
