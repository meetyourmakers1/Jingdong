            ...
            <div class="col-md-6">
                <section class="section sign-in inner-right-xs">
                    ...
                    <div class="social-auth-buttons">
                        <div class="row">
                            <div class="col-md-6">
                                <button id='login_qq' class="btn-block btn-lg btn btn-facebook">
                                    <i class="fa fa-qq"></i> 
                                    使用QQ账号登录
                                </button>
                            </div>
                            <div class="col-md-6">
                                <button id='login_weibo' class="btn-block btn-lg btn btn-twitter">
                    ...
                    <div class="field-row clearfix">
                        ...
                        <span class="pull-right">
                            <a href="#" class="content-color bold">
                                忘记密码 ?
                            </a>
                        </span>
                    </div>
