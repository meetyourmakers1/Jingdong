                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <div class="basket-item">
                                            ...
                                            <a class="close-btn" href="<?php /*echo yii\helpers\Url::to(['cart/del', 'id' => $product['id']])*/ ?>"></a>
                                        </div>
                                    </li>
                                    <?php 
                                        /*endforeach; */
                                        ...
                                        <div class="basket-item">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6">
                                                    <a href="<?php /*echo yii\helpers\Url::to(['cart/index'])*/ ?>" class="le-button inverse">查看购物车
                                                    </a>
                                                </div>
                                                <div class="col-xs-12 col-sm-6">
